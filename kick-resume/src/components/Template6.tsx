...
const Template6 = ({ data, handleStringFeildClick, handleArrayFieldClick, handleExperienceFieldClick, handleProjectFieldClick, handleEducationFieldClick, handlePhoneClickFeild, handleEmailFieldClick }: {
    data: Data,
        ...
        <div className="bg-myWhite shadow-[0px_0px_46px_0px_rgba(0,_0,_0,_0.1)] px-7 py-7 lg:w-[70%] w-[100%] mx-auto">
            <div className="flex flex-col gap-2 items-start justify-center w-full">
                <div className="text-center">
                    <h1 className="lg:text-4xl md:text-3xl text-2xl font-bold text-gray-800 cursor-pointer text-left"
                        onClick={() => handleStringFeildClick("name", data.name)}
                    >{data.name}</h1>
                    <h2 className=" text-left cursor-pointer md:text-xl text-lg md:font-bold font-semibold text-blue-500"
                ...
                <div className="flex md:flex-row flex-col md:gap-20  gap-5 text-gray-500 md:text-sm text-xs w-full">
            ...
            >
                ...
                <h1 className="md:text-xl text-lg text-left font-bold text-gray-800">Summary</h1>
            ...
            >
                ...
                <h1 className="md:text-xl text-lg font-bold text-gray-800 text-left">Experience</h1>
                        ...
                        <div key={i} className="flex flex-col mt-3">
                            ...
                            <div className="flex justify-between">
                                <div className="md:text-[16px] text-sm flex flex-col gap-1 justify-center">
                                    <h1 className='font-bold text-blue-500'>{item.companyName}</h1>
            ...
            >
                ...
                <h1 className="md:text-xl text-lg text-left font-bold text-gray-800">Education</h1>
            ...
            >
                <h1 className="md:text-xl text-lg text-left font-bold text-gray-800">Skills</h1>
                <div
                    className="
            ...
            >
                <h1
                    className="md:text-xl text-lg text-left font-bold text-gray-800"
                >
                    Certifications
                </h1>
            ...
            >
                ...
                <h1 className="md:text-xl text-lg text-left font-bold text-gray-800">Projects</h1>
