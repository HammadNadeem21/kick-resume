...
const Template9 = ({
    ...
    return (
        <div className="bg-myWhite lg:w-[70%] w-[100%] mx-auto shadow-[0px_0px_46px_0px_rgba(0,_0,_0,_0.1)] px-[60px]">
            ...
            <div className="grid grid-cols-[30%,70%] gap-3 w-[100%]  py-5"
            //  style={{ backgroundColor: `rgba(${color.r}, ${color.g}, ${color.b}, 1)` }}
             >
                
            <div className={`flex justify-end items-center h-[180px] w-[180px] mt-4 rounded-full overflow-hidden ${imageBgColor || 'bg-gray-300'}`}>
                    <Image src={imageUrl ?? '/dummy.jpg'} alt='User' height={200} width={200} className='w-full h-full object-cover' />
                </div>
                
                
                <div className="">
                    <div className='text-[#004aad]  border-b-2 border-[#004aad] py-4 mt-7'>
                        <h1 className="lg:text-3xl md:text-2xl text-xl font-bold cursor-pointer " 
                            onClick={() => handleStringFeildClick("name", data.name)}
                        >{data.name}</h1>
                        <h2 className="cursor-pointer md:text-xl text-lg font-semibold"
                        ...
                        <div className="grid grid-cols-3 mt-2 text-xs text-black">
                            <div className="border-r-2 border-[#004aad] h-10 flex items-center justify-center cursor-pointer"
                             onClick={() => handleEmailFieldClick("email", data.email)}
                            >{data.email !== "" ? data.email : 'Email'}</div>
                            <div className="border-r-2 border-[#004aad] h-10 flex items-center justify-center cursor-pointer"
                             onClick={() => handlePhoneClickFeild('phone', data.phone)}
                            >{data.phone && data.phone !== 0 ? `+${data.phone}` : 'Phone'}</div>
                            <div className=" h-10 flex items-center justify-center text-center   cursor-pointer"
                            onClick={() => handleStringFeildClick('address', data.address)}
                            >{data.address !== "" ? data.address : 'Address'}</div>
            ...
            {/* <div className="h-[2px] w-full bg-gray-400 mt-5 mb-5"></div> */}
                                ...
                                <div className=" grid grid-cols-[auto,1fr] gap-10">
                                    <div className="text-[#004aad] text-lg font-bold uppercase">Profile Summary</div>
                                    <div className=" flex flex-col justify-center">
                                        <div className="h-[2px] bg-[#004aad]"></div>
                                    </div>
                                </div>
                                <p className='text-gray-800 md:text-sm text-xs mt-2 leading-relaxed italic cursor-pointer'
                    ...
                    <div className=" grid grid-cols-[auto,1fr] gap-10 mt-6">
                                    <div className="text-[#004aad] text-lg font-bold uppercase">Education</div>
                                    <div className=" flex flex-col justify-center">
                                        <div className="h-[2px] bg-[#004aad]"></div>
                                    </div>
                                </div>
                            ...
                            {data.education.map((item: any, i: number) => (
                                    ...
                                    <ul  key={i} className="list-disc md:text-sm text-xs text-black flex justify-between items-center cursor-pointer"
                                    ...
                                    >
                                        ...
                                        {(item.startDate && item.endDate) && (
                                            ...
                                            ({item.startDate} - {item.endDate})
                                                    ...
                                                    {/* Experience */}
                                                    <div className=" grid grid-cols-[auto,1fr] gap-10 mt-6">
                                    <div className="text-[#004aad] text-lg font-bold uppercase">Work Experience</div>
                                    <div className=" flex flex-col justify-center">
                                        <div className="h-[2px] bg-[#004aad]"></div>
                                    </div>
                                </div>
                            ...
                            {data.experience.map((item: any, i: number) => (
                                <div key={i} className="flex flex-col mt-3 cursor-pointer"
                                ...
                                >
                                    <div className="flex flex-col ">
                                        <ul className=" md:text-[15px] text-xs flex items-center justify-between gap-5 text-black">
                                            ...
                                            >{`${item.title} | ${item.companyName}`}</li>
...
<div className=" grid grid-cols-[auto,1fr] gap-5 mt-6">
                                    <div className="text-[#004aad] text-lg font-bold uppercase">Professional Skill</div>
                                    <div className=" flex flex-col justify-center">
                                        <div className="h-[2px] bg-[#004aad]"></div>
                                    </div>
                                </div>
                        ...
                        <div className="mt-3 grid grid-cols-3 gap-2 cursor-pointer"
...
<div className=" grid grid-cols-[auto,1fr] gap-5 mt-6">
                                    <div className="text-[#004aad] text-lg font-bold uppercase">Certifications</div>
                                    <div className=" flex flex-col justify-center">
                                        <div className="h-[2px] bg-[#004aad]"></div>
                                    </div>
                                </div>
                    ...
                    {/* Project */}
                    <div className=" grid grid-cols-[auto,1fr] gap-10 mt-6">
                                    <div className="text-[#004aad] text-lg font-bold uppercase">Projects</div>
                                    <div className=" flex flex-col justify-center">
                                        <div className="h-[2px] bg-[#004aad]"></div>
                                    </div>
                                </div>
