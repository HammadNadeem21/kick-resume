...
const Template5 = ({ data, handleStringFeildClick, handleArrayFieldClick, handleExperienceFieldClick, handleProjectFieldClick, handleEducationFieldClick, handlePhoneClickFeild, handleEmailFieldClick }: {
    data: Data,
    ...
    return (
        <div className="bg-myWhite px-7 py-7 lg:w-[70%] w-[100%] mx-auto">
            <div className="flex flex-col gap-2 md:items-center items-start justify-center">
                ...
                >{data.name}</h1>
                <h2 className=" text-center cursor-pointer md:text-2xl text-xl md:font-bold font-semibold text-gray-700"
            ...
            <div className="h-[2px] w-full bg-gray-400 mt-5 mb-5"></div>
                    ...
                    >
                            ...
                            <h1 className="md:text-xl text-lg text-center font-bold text-gray-800">Summary</h1>
                    ...
                    >
                            ...
                            <h1 className="md:text-xl text-lg font-bold text-gray-800 text-center">Experience</h1>
                    ...
                    >
                            ...
                            <h1 className="md:text-xl text-lg text-center font-bold text-gray-800">Education</h1>
                    ...
                    >
                        <h1 className="md:text-xl text-lg text-center font-bold text-gray-800">Skills</h1>
                        <div
                            className="
                    ...
                    >
                        <h1
                            className="md:text-xl text-lg text-center font-bold text-gray-800"
                        >
                            Certifications
                        </h1>
                    ...
                    >
                            ...
                            <h1 className="md:text-xl text-lg text-center font-bold text-gray-800">Projects</h1>
