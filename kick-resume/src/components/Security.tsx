...
const Security = () => {
  return (
    <div className="bg-myLightestBlue py-[100px] px-4 flex flex-col  gap-10">
      {/* Heading */}
      ...
      <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 mt-[60px] sm:px-8 px-2">
