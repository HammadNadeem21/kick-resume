...
const Template4 = ({
  ...
  return (
    <div className="bg-myWhite lg:w-[70%] w-[100%] mx-auto shadow-lg shadow-myMidPurple/70">
      <div
      ...
      >
        <div className="">
          <div className="">
            <h1
              className="lg:text-4xl md:text-3xl text-2xl font-bold cursor-pointer text-white"
              onClick={() => handleStringFeildClick("name", data.name)}
            >
              {data.name}
            </h1>
            <h2
              className="cursor-pointer md:text-2xl text-xl md:font-bold font-semibold text-white"
