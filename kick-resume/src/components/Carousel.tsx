      ...
      <CarouselContent>
        {array.map((template) => (
          ...
          >
            ...
            >
              <div className="sm:h-[240px] h-[250px] w-full shadow-md shadow-mySkyBlue ">
                <Image
                  src={template.image}
                  alt={template.name}
                  height={500}
              ...
              {selectedTemplate === template.id && (
                <div
                  className="absolute inset-0 sm:h-[240px] h-[250px] w-full bg-gray-700 bg-opacity-50 flex items-center justify-center"
                  style={{ zIndex: 10 }}
                >
