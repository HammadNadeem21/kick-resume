...
const Template10 = ({ data, handleStringFeildClick, handleArrayFieldClick, handleExperienceFieldClick, handleProjectFieldClick, handleEducationFieldClick, handlePhoneClickFeild, handleEmailFieldClick }: {
    data: Data,
        ...
        <div className="bg-myWhite shadow-[0px_0px_46px_0px_rgba(0,_0,_0,_0.1)] px-7 py-7 lg:w-[70%] w-[100%] mx-auto">
            <div className="flex flex-col gap-2 items-start justify-center w-full">
                <div className="text-center w-full">
                    <h1 className="lg:text-4xl md:text-3xl text-2xl font-bold text-gray-800 cursor-pointer text-center"
                        onClick={() => handleStringFeildClick("name", data.name)}
                    >{data.name}</h1>
                    <h2 className=" text-center cursor-pointer md:text-xl text-lg text-black font-bold"
            ...
            >
                ...
                <h1 className="bg-[#d9d9d9] py-[2px] rounded-full px-3 italic md:text-xl text-lg text-left font-bold text-[#373643] uppercase">Summary</h1>
            ...
            >
                <h1 className="bg-[#d9d9d9] py-[2px] rounded-full px-3 italic md:text-xl text-lg text-left font-bold text-[#373643] uppercase">technical skills</h1>
  ...
  "
            ...
            >
                ...
                <h1 className="bg-[#d9d9d9] py-[2px] rounded-full px-3 italic md:text-xl text-lg text-left font-bold text-[#373643] uppercase">Experience</h1>
            ...
            >
                ...
                <h1 className="bg-[#d9d9d9] py-[2px] rounded-full px-3 italic md:text-xl text-lg text-left font-bold text-[#373643] uppercase">education</h1>
            ...
            >
                <h1 className="bg-[#d9d9d9] py-[2px] rounded-full px-3 italic md:text-xl text-lg text-left font-bold text-[#373643] uppercase"> additional information</h1>
            ...
            >
                ...
                <h1 className="bg-[#d9d9d9] py-[2px] rounded-full px-3 italic md:text-xl text-lg text-left font-bold text-[#373643] uppercase"> projects</h1>
